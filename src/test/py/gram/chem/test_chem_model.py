...
from gram.chem.rule_form_wextconj import BinaryJoinPropertyRule
...
class TestChemModel(unittest.TestCase):
    ...
    def _test_model(self, model_type, eta_0, evaluate):
        ...
        F_0.add_feature_type(FeatureAtomicBondType(atomic_domain))
        ...
        l1_hist = modell1.train_l1(D, F_0, iterations=1000, C=16.0, eta_0=eta_0, alpha=0.8, evaluation_fn=eval_dev)
